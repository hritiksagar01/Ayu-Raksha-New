...
export default function UploaderLoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      // Remember portal for potential callback-based flows
      ...
      if (response.success && response.data?.user) {
        ...
        toast({
          variant: 'destructive',
          title: 'Error',
          description: msg.includes('token') ? `${msg}. Please verify your email or try logging in again.` : msg,
        });
      }
    } catch (err: unknown) {
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked: boolean) => setValue('rememberMe', checked as boolean)}
                  />
